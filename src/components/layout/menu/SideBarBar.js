...
class SideBarBar extends React.Component {
                    ...
                    <div className="nk-sidebar-content">
                        <div className="nk-sidebar-widget d-none d-xl-block">
                            ...
                            <div className="user-account-actions">
                                <ul className="g-3">
                                    <li>
                                        <Link to="/transactions/create/expense" className="btn btn-lg btn-warning"><span>Gasto</span></Link>
                                    </li>
                                    <li>
                                        <Link to="/transactions/create/income" className="btn btn-lg btn-success"><span>Ingreso</span></Link>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="nk-sidebar-menu">
                            ...
                            <ul className="nk-menu">
                                ...
                                <li className="nk-menu-item">
                                    <Link to="/accounts/cash" className="nk-menu-link">
                                        <span className="nk-menu-icon"><em className="icon ni ni-wallet-alt"></em></span>
                                        <span className="nk-menu-text">Cuentas</span>
                                    </Link>
                                </li>
                                <li className="nk-menu-item">
                                    <Link to="/accounts/creditcards" className="nk-menu-link">
                                        <span className="nk-menu-icon"><em className="icon ni ni-coins"></em></span>
                                        <span className="nk-menu-text">Tarjetas de Credito</span>
                                    </Link>
                                </li>
                                <li className="nk-menu-item">
